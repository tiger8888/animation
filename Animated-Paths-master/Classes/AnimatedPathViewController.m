...
- (void) setupDrawingLayer
{
    ...
    pathLayer.strokeColor = [[UIColor blackColor] CGColor];// 边缘线的颜色
    pathLayer.fillColor = nil;   // 闭环填充的颜色
    pathLayer.lineWidth = 10.0f; // 线条宽度
...
- (void) setupTextLayer
{
    ...
    NSDictionary *attrs = [NSDictionary dictionaryWithObjectsAndKeys:
                           ...
                           nil];
    NSAttributedString *attrString = [[NSAttributedString alloc] initWithString:@"rungame.me"
                                                                     attributes:attrs];
